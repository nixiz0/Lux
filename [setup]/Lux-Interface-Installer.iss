; ---[TO BUILD THE .EXE INSTALLER, FIRST CLONE THE CLEAN PROJECT FROM THE GITHUB REPO (rename it Lux). ENSURE THE PROJECT IS EMPTY, WITHOUT ANY ADDITIONAL MODIFICATIONS OR FILES]---
; ---[THIS WILL KEEP THE PROJECT AS NEUTRAL AS POSSIBLE FOR COMPILING THE INSTALLER, PREVENTING UNNECESSARY FILES FROM BEING INCLUDED]---
