...
# Audio Config
TEMP_AUDIO_PATH = "audio/speech_to_text/temp_audio/audio.wav"  # Folder to store temp audio recorded
MIC_INDEX = 1
AUDIO_THRESHOLD = 500

# Voice Config
if LANGUAGE == 'fr':
    AUDIO_VOICE_PATH = "audio/synthetic_voice/fr_lux_voice.wav"
else: 
    AUDIO_VOICE_PATH = "audio/synthetic_voice/en_lux_voice.wav"
TEMP_OUTPUT_VOICE_PATH = "audio/synthetic_voice/temp_voice/voice_output.wav"
TEMP_OUTPUT_FOLDER_VOICE_PATH = "audio/synthetic_voice/temp_voice/"
SPEED_VOICE = 1.8
...
TEMP_TOOLS_DB_PATH = "agent_llm/rag/tools_vector_db"
...
# LLM Personality
SYSTEM_INSTRUCTION_PATH = "agent_llm/build_llm/"
if LANGUAGE == 'fr':
